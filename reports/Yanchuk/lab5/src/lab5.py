...
def generate_series(a, b, c, d, x_min=-10, x_max=10, step=0.1):
...
def main():
    x_vals, y_vals = generate_series(a, b, c, d, x_min=-10, x_max=10, step=0.1)
    ...
    train_df.to_csv(os.path.join(OUT_DIR, "train_results.csv"), index=False, encoding="utf-8-sig")
    test_df.to_csv(os.path.join(OUT_DIR, "test_results.csv"), index=False, encoding="utf-8-sig")
    ...
    print(" - loss_curve.png, prediction_vs_true.png")
